package com.bugtracker.resources;
...
public class ReportBug extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//ReportBug edited for first time.
		...
		try{
			...
			//String insertquery = "insert into bug (loginid, password, name, email, type) values(?,?,?,?,?,?,?,?,?,?,?,?)" ;
			String insertquery = "insert into bug (bugid,authorid,author,prodid,prodname,env,type,description,rep_date,priority,status,assign_to) values(?,?,?,?,?,?,?,?,?,?,?,?)" ;
